...
echo scp -i $EC2KEYNAME access_key.txt azureuser@$JUMPHOSTIP0:/home/azureuser/
echo scp -i $EC2KEYNAME secret_key.txt azureuser@$JUMPHOSTIP0:/home/azureuser/
...
echo scp -i $EC2KEYNAME access_key.txt azureuser@$JUMPHOSTIP1:/home/azureuser/
echo scp -i $EC2KEYNAME secret_key.txt azureuser@$JUMPHOSTIP1:/home/azureuser/
